...
function fillRealVersion(meta, packageName = 'awen-components-demo', version = '0.1.0', basicLibraryVersion={"@alifd/next":"1.25.23","@alifd/meet":"2.6.3","antd":"4.17.3"}) {
  if (!meta || !version) {
    return meta;
  }
  const { npm } = meta;
...
if (!execCompile) {
  window.AwenComponentsDemoMeta = { components, componentList };
}